...
/*
 * Plugin Name: BrandIt Contact Info
...
class BrandIt_Contact_Info {
	...
	function add_to_admin_menu() {
		$main_menu_page_hook = add_menu_page(
			esc_html__( 'Contact Info', 'bci-domain' ),
			esc_html__( 'Contact Info', 'bci-domain' ),
			'manage_options',
	...
	protected function handle_form_submit() {
		...
		if (
			...
			$this->render_error_message( __( 'Sorry, you are not allowed to manage contact forms.', 'bci-domain' ) );
		...
		$this->render_success_message( __( 'Your contact info has been saved.', 'bci-domain' ) );
	}
	...
	function contact_info_admin_page_html() {
        ...
        <div class="wrap my-contact-info-settings">
            <h1><?php echo esc_html__( 'Your Business Contact Information', 'bci-domain' ); ?></h1>
                ...
                <div class="form-group">
                    <div class="form-floating">
                        ...
                        <label for="<?php echo self::OPTION_CONTACT_EMAIL_ADDRESS ?>">
							<?php esc_html_e( 'Email', 'bci-domain' ); ?>
                        </label>
                    </div>
                    <p class="description">
						<?php esc_html_e( 'Enter your business email address that will be used for contact purposes.', 'bci-domain' ) ?>
                    </p>
                </div>
                ...
                <div class="form-group">
                    <div class="form-floating">
                        ...
                        <label for="<?php echo self::OPTION_CONTACT_ADDRESS ?>">
							<?php esc_html_e( 'Address', 'bci-domain' ); ?>
                        </label>
                    </div>
                    <p class="description">
						<?php esc_html_e( 'Provide the primary address where you can be reached or where your business is located.', 'bci-domain' ) ?>
                    </p>
                </div>
                ...
                <div class="form-group">
                    <div class="form-floating">
                        ...
                        <label for="<?php echo self::OPTION_CONTACT_PHONE_NUMBER ?>">
							<?php esc_html_e( 'Phone Number', 'bci-domain' ); ?>
                        </label>
                    </div>
                    <p class="description">
						<?php esc_html_e( 'Enter your business contact phone number in the correct format, e.g., +359891234567 or 0891234567.', 'bci-domain' ) ?>
                    </p>
                </div>

                <input type="submit" id="submit" class="button button-primary"
                       value="<?php esc_html_e( 'Save Changes', 'bci-domain' ) ?>">
            </form>
        </div>
