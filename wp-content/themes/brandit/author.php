...
get_template_part(
	...
	null,
	array(
		'page_title'    => 'Blog posts by: ' . $author_name,
		'page_subtitle' => $author_bio,
	)
);
?>

    <section class="blog-section page-section container-xxl author-archive-page">
            ...
            <div class="container">
                <div class="text-center">
                    ...
                    <h1 class="display-5 mb-5">
                        Check out the latest posts from this author.
                    </h1>
                </div>
            </div>
        </div>
